...
export const TestimonialsSection: React.FC = () => {
  ...
  return (
    <section id="depoimentos" className="py-12 sm:py-16 md:py-24 bg-white text-black border-t border-b border-neutral-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        {/* Grid de Depoimentos sem aspas nem pontos finais */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {testimonials.map((t, idx) => (
            <div
              key={idx}
              className="p-6 sm:p-8 bg-neutral-50 border border-neutral-200 hover:border-[#D4AF37] transition-all duration-300 rounded-xs shadow-xs hover:shadow-lg flex flex-col justify-between relative group"
            >
